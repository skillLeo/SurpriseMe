...
namespace App\Models {
     ...
     * @property string $friend_token
     * @property string $user_token
     * @property string $friend_phone
     * @property string $friend_name
     * @property string $user_phone
     * @property string $user_name
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\VoiceMessage> $voiceMessages
     * @property-read int|null $voiceMessages_count
     * @method static \Illuminate\Database\Eloquent\Builder<Submission>|Submission whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Submission>|Submission whereUserName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Submission>|Submission whereUserPhone($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Submission>|Submission whereFriendName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Submission>|Submission whereFriendPhone($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Submission>|Submission whereUserToken($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Submission>|Submission whereFriendToken($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Submission>|Submission whereExpiresAt($value)
     ...
     * @property int $id
     * @property-read mixed $audio_url
     * @property-read \App\Models\Submission $submission
     * @method static \Illuminate\Database\Eloquent\Builder<VoiceMessage>|VoiceMessage whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<VoiceMessage>|VoiceMessage whereSubmissionId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<VoiceMessage>|VoiceMessage whereFileName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<VoiceMessage>|VoiceMessage whereShareToken($value)
     * @method static \Illuminate\Database\Eloquent\Builder<VoiceMessage>|VoiceMessage whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<VoiceMessage>|VoiceMessage whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<VoiceMessage>|VoiceMessage newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<VoiceMessage>|VoiceMessage newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<VoiceMessage>|VoiceMessage query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<VoiceMessage>|VoiceMessage timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class VoiceMessage extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
