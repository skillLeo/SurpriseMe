    ...
    <div class="w-full max-w-lg">
        ...
        <div class="flex justify-center gap-3 mb-10">
            ...
            <div class="flex items-center gap-3">
                <div class="step-dot w-10 h-10 rounded-full flex items-center justify-center text-sm font-700 {{ $step === 2 ? 'active text-white' : 'glass text-white/40' }}">
                    {{ $step }}
                </div>
                @if($step < 4)
        ...
        <form method="POST" action="{{ route('form.store') }}" class="space-y-6 fade-in-up delay-1">
            ...
            <div class="glass rounded-xl p-4 flex items-start gap-3">
                ...
                <p class="text-white/50 text-xs leading-relaxed">
                    Both you and your friend will instantly receive a unique surprise gift shopping link via SMS from <strong class="text-pink-400">SurpriseMe</strong>. Links are active for 60 days.
                </p>
            </div>
