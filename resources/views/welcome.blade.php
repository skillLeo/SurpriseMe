...
<style>
    ...
    .feature-card:hover {
        ...
        box-shadow: 0 6px 24px rgba(233, 30, 140, 0.11);
    }
    ...
    .cta-btn:hover {
        transform: translateY(-3px);
        box-shadow: 0 10px 44px rgba(233, 30, 140, 0.55);
    }
    ...
    .divider-line {
        flex: 1; height: 1px;
        background: linear-gradient(90deg, transparent, #E0D0EE, transparent);
    }
</style>
@endsection
...
<div class="min-h-screen flex flex-col items-center justify-center px-4 py-20">
    <div class="w-full max-w-xl">
        ...
        <p class="text-center text-gray-300 text-xs mt-10">SurpriseMe · Spread the love ✨</p>
